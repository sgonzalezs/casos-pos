...
function SaveCase(){
	...
	var file=document.getElementById("file_Case").files[0].size;
	...
	if(nit=="" || clnt=="" || asnt =="" || desc=="" || ac=="" || bol){
		swal("Revisa que los campos estén bien diligenciados","","error");	
	}else if(file>2097152){
		swal("El archivo adjunto pesa mas del tamaño permitido ("+(file/1048576).toFixed(0)+" mb)","","error");
	}
	else{
