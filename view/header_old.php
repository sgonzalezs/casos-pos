              ...
              <form class="container-fluid">
                <div class="row" id="divNewCase">
                    <div class="col-md-3">
                      ...
                      <input type="text" class="form-control" id="txt_nitCase" list="listClients" onchange="ListClient();" />
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="text" class="form-control" id="txt_clientCase" name="">
                    </div>
                    <div class="col-md-5">
                      <label for="message-text" class="col-form-label">Asunto:</label>
                      <input type="text" class="form-control" id="txt_AsntCase" name="">
                    </div>
                      <div class="col-md-10">
                      <label for="message-text" class="col-form-label">Descripción:</label>
                      <textarea class="form-control" id="txa_DescCase" ></textarea>
                    </div>
                                  <!-- <div class="col-md-2">
                                    <label class="col-form-label">Adjuntar archivo</label>
                                    <input type="file" class="form-control" id="fileCase" name="fileCase">
                                  </div> -->
                    <div class="col-md-4">
                      <label for="message-text" class="col-form-label">Entorno:</label>
                    ...
                    <div class="col-md-4">
                      ...
                      <select class="form-control" id="slc_SoftCase">
                                      
                      </select>
                    </div>
                    <div class="col-md-4">
                      <label for="message-text" class="col-form-label">Asesor:</label>
                      <select class="form-control" id="slc_AcCase">
                        <option value="">Seleccione --</option>
                        <?= $listAc;?> 
                      </select>
                    </div>
